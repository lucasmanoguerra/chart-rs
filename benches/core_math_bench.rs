use chart_rs::api::{
    ...
    CrosshairLabelBoxVisibilityPriority, CrosshairLabelBoxWidthMode, LastPriceLabelBoxWidthMode,
...
fn bench_last_price_visible_source_render(c: &mut Criterion) {
    let mut engine = ChartEngine::new(
        NullRenderer::default(),
        ChartEngineConfig::new(Viewport::new(920, 420), 0.0, 2_000.0)
            .with_price_domain(90.0, 140.0),
    ...
    engine.set_data(points);
    engine
        .set_time_visible_range(400.0, 1_200.0)
    ...
    c.bench_function("last_price_visible_source_render", |b| {
        b.iter(|| {
            let _ = engine.build_render_frame().expect("build render frame");
        })
    });
...
fn bench_last_price_label_box_fit_text_render(c: &mut Criterion) {
    let mut engine = ChartEngine::new(
        NullRenderer::default(),
        ChartEngineConfig::new(Viewport::new(920, 420), 0.0, 2_000.0)
            .with_price_domain(90.0, 140.0),
    ...
    engine
        .set_render_style(RenderStyle {
            ...
            last_price_label_box_min_width_px: 72.0,
            ..engine.render_style()
        })
        .expect("set style");

    c.bench_function("last_price_label_box_fit_text_render", |b| {
        b.iter(|| {
            let _ = engine.build_render_frame().expect("build render frame");
        })
    });
...
fn bench_price_axis_inset_policy_render(c: &mut Criterion) {
    let mut engine = ChartEngine::new(
        NullRenderer::default(),
        ChartEngineConfig::new(Viewport::new(920, 420), 0.0, 2_000.0)
            .with_price_domain(90.0, 140.0),
    ...
    engine
        .set_render_style(RenderStyle {
            ...
            price_axis_tick_mark_length_px: 10.0,
            ..engine.render_style()
        })
        .expect("set style");

    c.bench_function("price_axis_inset_policy_render", |b| {
        b.iter(|| {
            let _ = engine.build_render_frame().expect("build render frame");
        })
    });
...
fn bench_price_axis_tick_mark_style_render(c: &mut Criterion) {
    let mut engine = ChartEngine::new(
        NullRenderer::default(),
        ChartEngineConfig::new(Viewport::new(920, 420), 0.0, 2_000.0)
            .with_price_domain(90.0, 140.0),
    ...
    engine
        .set_render_style(RenderStyle {
            ...
            show_last_price_label: true,
            price_axis_tick_mark_length_px: 10.0,
            price_axis_tick_mark_width: 2.0,
            price_axis_tick_mark_color: Color::rgb(0.85, 0.24, 0.24),
            ..engine.render_style()
        })
        .expect("set style");

    c.bench_function("price_axis_tick_mark_style_render", |b| {
        b.iter(|| {
            let _ = engine.build_render_frame().expect("build render frame");
        })
    });
...
fn bench_time_axis_border_hidden_render(c: &mut Criterion) {
    let mut engine = ChartEngine::new(
        NullRenderer::default(),
        ChartEngineConfig::new(Viewport::new(920, 420), 0.0, 2_000.0)
            .with_price_domain(90.0, 140.0),
    ...
    c.bench_function("time_axis_border_hidden_render", |b| {
        b.iter(|| {
            let _ = engine.build_render_frame().expect("build render frame");
        })
    });
...
fn bench_price_axis_border_hidden_render(c: &mut Criterion) {
    let mut engine = ChartEngine::new(
        NullRenderer::default(),
        ChartEngineConfig::new(Viewport::new(920, 420), 0.0, 2_000.0)
            .with_price_domain(90.0, 140.0),
    ...
    c.bench_function("price_axis_border_hidden_render", |b| {
        b.iter(|| {
            let _ = engine.build_render_frame().expect("build render frame");
        })
    });
...
criterion_group!(
    ...
    bench_time_axis_border_hidden_render,
    bench_price_axis_border_hidden_render,
