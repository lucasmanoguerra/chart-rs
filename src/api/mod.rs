...
use crate::core::{
    ...
    LineSegment, OhlcBar, PriceScale, PriceScaleMode, TimeScale, Viewport, candles_in_time_window,
...
use crate::extensions::{
    ChartPlugin, MarkerPlacementConfig, PlacedMarker, PluginEvent, SeriesMarker,
