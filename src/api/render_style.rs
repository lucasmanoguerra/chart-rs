...
impl Default for RenderStyle {
    fn default() -> Self {
        Self {
            ...
            // Lightweight Charts v5.x default text color is #191919.
            time_axis_label_color: Color::rgb(0.10, 0.10, 0.10),
            major_time_label_color: Color::rgb(0.10, 0.10, 0.10),
            axis_label_color: Color::rgb(0.10, 0.10, 0.10),
            // Lightweight Charts v5.x default crosshair line color is #758696.
            crosshair_line_color: Color::rgb(0.46, 0.53, 0.59),
            ...
            crosshair_label_box_color: Color::rgb(0.30, 0.32, 0.37),
            crosshair_time_label_box_color: None,
            crosshair_price_label_box_color: None,
            crosshair_label_box_text_color: Color::rgb(1.0, 1.0, 1.0),
