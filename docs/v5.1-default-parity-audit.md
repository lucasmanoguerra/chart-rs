...
- Wire visible-window autoScale refresh into core pan/zoom flows (currently available via `autoscale_price_from_visible_*` APIs and enabled in GTK parity examples).
